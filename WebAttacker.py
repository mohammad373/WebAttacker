...
if c == 1:
      ...
      def __color__():
          ...
          try:
              ...
              if color == 1:
                  try:
                      time.sleep(1)
                      print("\nOk Pleass 5 sec Latter ;)")
                      time.sleep(1)
                      print(Fore.BLUE + "\n[" + Fore.YELLOW + "*" + Fore.BLUE + "]" + Fore.GREEN + " ~ " + Fore.GREEN + "Pleass 5 Sec Latter ...")
                      time.sleep(1)
                      print(Fore.BLUE + "[" + Fore.YELLOW + "*" + Fore.BLUE + "]" + Fore.GREEN + " ~ " + Fore.GREEN + "Pleass 4 Sec Latter ...")
                      time.sleep(1)
                      print(Fore.BLUE + "[" + Fore.YELLOW + "*" + Fore.BLUE + "]" + Fore.GREEN + " ~ " + Fore.GREEN + "Pleass 3 Sec Latter ...")
                      time.sleep(1)
                      print(Fore.BLUE + "[" + Fore.YELLOW + "*" + Fore.BLUE + "]" + Fore.GREEN + " ~ " + Fore.GREEN + "Pleass 2 Sec Latter ...")
                      time.sleep(1)
              ...
              if color == 2:
                  try:
                      ...
                      try:
                          ...
                          pass
      # ________________       ( 3 )     ________________________________
      ...
      # _________________________            (  4  )   ___________________________________
              ...
              # __________
                  ...
                  try:
                      time.sleep(2)
                      print(Fore.RED + "\n[!] ~ Error : Your Number Or Number Text Is Not Found ;(")
                      time.sleep(2)
                      sys.exit()
                  except:
                      pass
...
if c == 3:
                    ...
                    def __web__():
                        ...
                        try:
                            time.sleep(2)
                            print(Fore.YELLOW + "Helloe . Welcome ;)")
                            time.sleep(2)
                            target = input(Fore.GREEN + "\nPleass Enter The Address WebSite ==>  ")
                            time.sleep(0.5)
                            if target == "" or None:
                                try:
                                    time.sleep(2)
                                    print(Fore.RED + "\n[!] - Error : Your Site In Not Found :/ ")
                                    time.sleep(1.2)
                                    print(Fore.YELLOW + "\n[*] - Go To The Mano ;)")
                                    time.sleep(1.2)
                                    os.system("clear")
  ...
  def __webip__():
      ...
      try:
          ...
          if target == "" or None:
              try:
                  time.sleep(1)
                  print(Fore.RED + "\n[!] - Error : Your Address Targett Is Not Found :/")
                  time.sleep(1)
                  sys.exit()
              except:
                  pass
